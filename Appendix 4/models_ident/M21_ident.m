function out = M21_ident(sys)

Np                  = 4;                                                    % Number of R,C parameters
...
sys.fun             = @M21;                                                 % model function, M41
...
xw0                 = [10   ; 30   ; 50];
xi0                 = [10   ; cte  ; 50];
gather              = [Rw Cw Ci aW sigw1 sigw2 sigv xw0 xi0];               % Gether in one variable
Vars                = {'Rw' 'Cw' 'Ci' 'aW' 'sigw1' ...                      % parameter names
                        'sigw2' 'sigv' 'xw0' 'xi0'}';                       % ...
...
fun                 = @(x) SquareRootGradPen([x(1:8) ; cte], sys);
