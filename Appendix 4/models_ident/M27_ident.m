...
sys.fun             = @M27;                                                 % model function, M41
...
xw0                 = [10   ; 29   ; 50];
xi0                 = [10   ; cte  ; 50];
gather              = [Ro Ri Rv Cw Ci aW aI sigw1 sigw2 sigv xw0 xi0];      % Gether in one variable
Vars                = {'Ro' 'Ri' 'Rv' 'Cw' 'Ci' 'aW' 'aI' 'sigw1' ...       % parameter names
                        'sigw2' 'sigv' 'xw0' 'xi0'}';                       % ...
