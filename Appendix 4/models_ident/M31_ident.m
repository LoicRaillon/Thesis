...
sys.fun             = @M31;                                                 % model function, M41
sys.Psqrt           = diag([0.5 0.5 0.1]);                                  % initial std of states
...
xm0                 = [10   ; 30   ; 50];
xi0                 = [10   ; cte  ; 50];
gather              = [Ro Ri Rm Rz Cw Cm Ci aW aI ...                       % Gether in one variable
                       sigw1 sigw2 sigw3 sigv xw0 xm0 xi0];                 % ...
Vars                = {'Ro' 'Ri' 'Rm' 'Rz' 'Cw' 'Cm' 'Ci' 'aW' 'aI' ...     % parameter names
                       'sigw1' 'sigw2' 'sigw3' 'sigv' 'xw0' 'xm0' 'xi0'}';  % ...
...
fun                 = @(x) SquareRootGradPen([x(1:15) ; cte], sys);         % Loglikelihood with penalty function
