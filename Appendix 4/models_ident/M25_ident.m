...
sys.fun             = @M25;                                                 % model function, M41
...
xw0                 = [10   ; 30   ; 50];
xi0                 = [10   ; cte  ; 50];
gather              = [Ro Ri Rv Cw Ci aW sigw1 sigw2 sigv xw0 xi0];         % Gether in one variable
Vars                = {'Ro' 'Ri' 'Rv' 'Cw' 'Ci' 'aW' 'sigw1' ...            % parameter names
                        'sigw2' 'sigv' 'xw0' 'xi0'}';                       % ...
