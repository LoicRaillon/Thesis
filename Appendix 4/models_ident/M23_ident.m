...
sys.fun             = @M23;                                                 % model function, M41
...
xw0                 = [10   ; 30   ; 50];
xi0                 = [10   ; cte  ; 50];
gather              = [Ro Ri Cw Ci aW aI sigw1 sigw2 sigv xw0 xi0];         % Gether in one variable
Vars                = {'Ro' 'Ri' 'Cw' 'Ci' 'aW' 'aI' 'sigw1' ...            % parameter names
                         'sigw2' 'sigv' 'xw0' 'xi0'}';                      % ...
