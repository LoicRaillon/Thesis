function out = M26_ident(sys)

Np                  = 7;                                                    % Number of R,C parameters
...
sys.fun             = @M26;                                                 % model function, M41
...
xw0                 = [10   ; 30   ; 50];
xi0                 = [10   ; cte  ; 50];
gather              = [Ro Ri Rz Cw Ci aW aI sigw1 sigw2 sigv xw0 xi0];      % Gether in one variable
Vars                = {'Ro' 'Ri' 'Rz' 'Cw' 'Ci' 'aW' 'aI' 'sigw1'...        % parameter names
                        'sigw2' 'sigv' 'xw0' 'xi0'}';                       % ...
...
fun                 = @(x) SquareRootGradPen([x(1:11) ; cte], sys);
