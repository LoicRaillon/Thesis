function out = M24_ident(sys)

Np                  = 6;                                                    % Number of R,C parameters
...
sys.fun             = @M24;                                                 % model function, M41
...
xw0                 = [10   ; 29   ; 50];
xi0                 = [10   ; cte  ; 50];
gather              = [Ro Ri Rz Cw Ci aW sigw1 sigw2 sigv xw0 xi0];         % Gether in one variable
Vars                = {'Ro' 'Ri' 'Rz' 'Cw' 'Ci' 'aW' 'sigw1' ...            % parameter names
                        'sigw2' 'sigv' 'xw0' 'xi0'}';                       % ...
...
fun                 = @(x) SquareRootGradPen([x(1:10) ; cte], sys);
